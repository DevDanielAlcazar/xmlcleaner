...
const translations = {
  es: {
    ...
    heroSubPro: "Potencia tu administración con limpieza inteligente, extracción masiva a Excel y validación SAT en tiempo real. La suite más completa para el manejo de CFDI.",
    moduleCleaningTitle: "Limpieza Inteligente",
    moduleCleaningDesc: "Reparación total de XMLs dañados y eliminación de caracteres ilegales.",
    moduleExcelTitle: "Extracción a Excel",
    moduleExcelDesc: "Convierte cientos de XMLs en reportes detallados de Excel en segundos. Exclusivo Pro.",
    moduleSatTitle: "Validador SAT",
    moduleSatDesc: "Verifica la vigencia de tus facturas directamente con el SAT de forma masiva. Exclusivo Pro.",
  ...
  en: {
    ...
    heroSubPro: "Power your administration with smart cleaning, bulk Excel extraction, and real-time SAT validation. The most complete suite for CFDI management.",
    moduleCleaningTitle: "Smart Cleaning",
    moduleCleaningDesc: "Total repair of damaged XMLs and removal of illegal characters.",
    moduleExcelTitle: "Excel Extraction",
    moduleExcelDesc: "Convert hundreds of XMLs into detailed Excel reports in seconds. Pro Exclusive.",
    moduleSatTitle: "SAT Validator",
    moduleSatDesc: "Verify the validity of your invoices directly with the SAT in bulk. Pro Exclusive.",
